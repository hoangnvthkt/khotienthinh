...
- Verification sau fix: targeted `5/5` files, `30/30` tests; full regression `413/413` files, `1966/1966` tests; TypeScript, production build, migration baseline `91 active / 402 archived`, `git diff --check` đều đạt. Cloud migration dry-run trả `upToDate=true`; không có migration/seed/role chờ apply.
