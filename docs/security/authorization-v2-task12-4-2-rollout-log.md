...
- `phase4_permission_surface_smoke` cũ dừng ở fixture trước assertion liên quan: test còn ghi tường minh bốn cột legacy trên `users`, hiện bị guard Task 12.4.2 chặn. Không dùng smoke này làm bằng chứng pass/fail của E11 và không nới guard chỉ để chạy test cũ.
