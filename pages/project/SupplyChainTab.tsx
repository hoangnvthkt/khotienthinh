...
const SupplyChainTab: React.FC<SupplyChainTabProps> = ({ constructionSiteId, projectId, canManageTab = true, compact = false, initialDraftPo = null, initialDraftPoKey = 0 }) => {
    ...
    const openCreatePo = async () => {
        ...
        resetPoForm();
        setPNum(await loadNextPoNumber('proactive_project'));
    ...
    const openPoFromSelectedRequests = async () => {
        ...
        setPNum(await loadNextPoNumber('from_request'));
        setPNumAutoGenerated(true);
        setPDate(new Date().toISOString().split('T')[0]);
        setPItems(rows);
    ...
    const handleSavePo = async () => {
        ...
        if (!finalPoNumber || !pTargetWarehouseId) {
                        ...
                        <div className="p-6 space-y-4">
                            <div className="grid grid-cols-2 gap-3">
                                <div>
                                    ...
                                    <input value={pNum} onChange={e => { setPNum(e.target.value); setPNumAutoGenerated(false); }} placeholder="PO-001"
