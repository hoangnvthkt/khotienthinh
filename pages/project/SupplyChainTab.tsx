...
const SupplyChainTab: React.FC<SupplyChainTabProps> = ({ constructionSiteId }) => {
    ...
    return (
        <div className="space-y-6">
            ...
            {/* Vendor Form Modal */}
            {showVendorForm && (
                <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={resetVendorForm}>
            ...
            {/* PO Form Modal */}
            {showPoForm && (
                <div className="fixed inset-0 z-[999] flex items-center justify-center bg-black/40 backdrop-blur-sm" onClick={resetPoForm}>
                    <div onClick={e => e.stopPropagation()} className="bg-white rounded-3xl shadow-2xl border border-slate-200 w-full max-w-lg mx-4 max-h-[90vh] overflow-y-auto">
