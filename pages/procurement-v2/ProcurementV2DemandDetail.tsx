    ...
    <div className="mx-auto max-w-7xl space-y-5">
      ...
      <header className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-700 dark:bg-slate-900 sm:p-7">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-start sm:justify-between">
          ...
          {dossier.sourceAdapter === 'material_plan' && dossier.sourceRef.canOpen === false
            ? <span className="inline-flex min-h-11 items-center rounded-xl border border-slate-300 px-4 text-sm text-slate-500 dark:border-slate-700">Tài liệu nguồn được bảo vệ</span>
