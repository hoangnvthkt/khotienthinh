...
const PAGES: SearchResult[] = [
  ...
  { id: 'p-project-v2', title: 'Dự án V2', subtitle: 'Không gian lập kế hoạch', category: 'Dự án', icon: <HardHat size={16} />, route: '/project-v2', keywords: 'du an v2 ke hoach thang thi cong vat tu' },
  ...
  { id: 'p-procurement', title: 'Mua hàng công ty', subtitle: 'Gom nhu cầu nhiều dự án thành PO công ty', category: 'Đơn hàng PO', icon: <ShoppingCart size={16} />, route: '/procurement', keywords: 'mua hang cong ty procurement gom don po cong ty nha cung cap' },
  { id: 'p-procurement-v2', title: 'Mua hàng V2', subtitle: 'Hồ sơ nhu cầu đã duyệt', category: 'Đơn hàng PO', icon: <ShoppingCart size={16} />, route: '/procurement-v2', keywords: 'mua hang v2 ho so nhu cau ke hoach vat tu' },
