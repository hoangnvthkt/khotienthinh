...
const VehicleBookingNotificationContent: React.FC<Props> = ({ notification }) => {
  ...
  if (!view) {
    return <p className="text-xs leading-5 text-gray-600 dark:text-gray-300">{notification.message}</p>;
  }

  return (
    <div className="min-w-0 space-y-1 text-xs leading-5 text-gray-600 dark:text-gray-300">
