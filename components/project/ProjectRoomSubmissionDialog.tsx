...
const ACTION_LABELS: Record<ProjectRoomActionCode, string> = {
  view: 'xem', edit: 'sửa', delete: 'xóa', submit: 'gửi', return: 'trả lại', verify: 'kiểm tra', confirm: 'xác nhận', approve: 'duyệt', publish_progress: 'công bố tiến độ ngày', view_available_stock: 'xem tồn khả dụng', view_resource_evidence: 'xem bằng chứng nguồn lực',
};
