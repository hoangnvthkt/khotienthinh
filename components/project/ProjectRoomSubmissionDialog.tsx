...
const ACTION_LABELS: Record<ProjectRoomActionCode, string> = {
  view: 'xem', edit: 'sửa', delete: 'xóa', submit: 'gửi', verify: 'kiểm tra', confirm: 'xác nhận', approve: 'duyệt', publish_progress: 'công bố tiến độ ngày', view_available_stock: 'xem tồn khả dụng',
};
