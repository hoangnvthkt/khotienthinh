          ...
          <table className="w-full min-w-[1780px] text-xs">
            <thead className="bg-slate-50 text-[9px] font-black uppercase tracking-wide text-slate-500">
              <tr>
                ...
                <th className="px-3 py-3 text-right">Nhu cầu 7d</th>
                <th className="px-3 py-3 text-right">Nhu cầu 30d</th>
                <th className="px-3 py-3 text-right">GT nhu cầu 30d</th>
                <th className="px-3 py-3 text-right">Nhu cầu 90d</th>
                <th className="px-3 py-3 text-right">Tồn CT</th>
                <th className="px-3 py-3 text-right">PO về 30d</th>
                <th className="px-3 py-3 text-right">Thiếu 30d</th>
