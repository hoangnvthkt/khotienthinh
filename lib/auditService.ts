...
const TABLE_MODULE_MAP: Record<string, string> = {
  ...
  purchase_orders: 'DA',
  supplier_payable_documents: 'TC',
  supplier_payment_batches: 'TC',
  supplier_payment_allocations: 'TC',
  site_direct_purchases: 'TC',
  site_direct_purchase_lines: 'TC',
  site_small_tool_records: 'TC',
  site_cash_settlement_batches: 'TC',
  site_cash_settlement_lines: 'TC',
  daily_logs: 'DA',
...
export const TABLE_LABELS: Record<string, string> = {
  ...
  supplier_payable_documents: 'Công nợ NCC',
  supplier_payment_batches: 'Đợt thanh toán NCC',
  supplier_payment_allocations: 'Phân bổ thanh toán NCC',
  site_direct_purchases: 'Mua nóng công trường',
  site_direct_purchase_lines: 'Dòng mua nóng',
  site_small_tool_records: 'Sổ CCDC nhỏ',
  site_cash_settlement_batches: 'Bộ hoàn ứng công trường',
  site_cash_settlement_lines: 'Dòng hoàn ứng công trường',
