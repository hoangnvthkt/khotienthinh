...
describe('purchase receipt workflow', () => {
    ...
    expect(payload.lines).toEqual([
      {
        ...
        itemId: 'item-1',
        documentedPurchaseQty: 8,
        countedPurchaseQty: 8,
        acceptedPurchaseQty: 8,
        documentedStockQty: 16,
        countedStockQty: 16,
        acceptedStockQty: 16,
      ...
      },
      {
        ...
        itemId: 'item-2',
        documentedPurchaseQty: 5,
        countedPurchaseQty: 5,
        acceptedPurchaseQty: 5,
        documentedStockQty: 5,
        countedStockQty: 5,
        acceptedStockQty: 5,
        varianceReason: null,
      },
  ...
  it('preserves separately entered delivered and accepted quantities in both units', () => {
    ...
    const payload = buildPurchaseReceiptQualityPayloadFromTransaction(transaction, [{
      index: 0,
      quantity: 101,
      documentedPurchaseQty: 103,
      countedPurchaseQty: 102,
