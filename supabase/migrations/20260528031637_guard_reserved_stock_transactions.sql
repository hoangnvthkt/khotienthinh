-- Make stock status transitions reservation-aware.
-- The previous RPC protected on-hand stock through apply_stock_change(), but it
-- did not subtract quantities already held by pending/approved outbound
-- transactions or active material requests before approving/completing another
