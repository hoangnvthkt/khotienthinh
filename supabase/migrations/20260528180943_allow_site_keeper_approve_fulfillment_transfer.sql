-- Let the destination/site warehouse keeper approve project fulfillment
-- transfer transactions. This keeps the field workflow as:
-- material team creates an issued batch -> site keeper checks quantity/quality
-- -> site keeper confirms receipt.
